#ifndef PARSE_REQUEST_CPP
#define PARSE_REQUEST_CPP
...
void Parser::private_create_automata(std::list<Token>& input, std::list<Token>::iterator& it,
...
std::shared_ptr<GrammarExprTree> Parser::parse_request(std::string rexpr) {
