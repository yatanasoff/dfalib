#ifndef DNA_LANG_PARSER_CPP
#define DNA_LANG_PARSER_CPP
...
map<string, set<string>> DNALangParser::parseString(const std::string& grammar){
//    list<string> chains = {};
...
map<string, set<string>> DNALangParser::parse(const list<std::string> chains){
